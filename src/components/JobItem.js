  ...
  return (
    <div className="job-item p-4 mb-4">
      <div className="row g-4">
        <div className="col-sm-12 col-md-8 d-flex align-items-center" onClick={() => navigate(`/job-detail/${job._id}`)} style={{ cursor: 'pointer' }}>
          ...
          <div className="text-start ps-4">
            ...
            <span className="text-truncate me-3"><i className="far fa-clock text-primary me-2"></i>{job.func_category?.label}</span>
        ...
        <div className="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
          <div className="d-flex mb-3">
            ...
            <a className="btn btn-primary" onClick={() => navigate(`/job-detail/${job._id}`)}>Apply Now</a>
          </div>
